...
/**************************************************************************/
/*
        Instantiates a new HIH6130 class with appropriate properties
*/
/**************************************************************************/
void HIH6130::getAddr_HIH6130(uint8_t i2cAddress)
{
    hih_i2cAddress = i2cAddress;
    hih_conversionDelay = HIH6130_CONVERSIONDELAY;
}
...
*/
/**************************************************************************/
void HIH6130::readRegister(uint8_t i2cAddress)
{
...
*/
/**************************************************************************/
float HIH6130::Measure_Humidity()
{
    return humidity;
}
...
*/
/**************************************************************************/
float HIH6130::Measure_Temperature()
{
    return temperature;
}
