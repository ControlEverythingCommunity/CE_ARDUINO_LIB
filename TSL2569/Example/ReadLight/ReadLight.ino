...
void setup(void)
{
    ...
    tsl.getAddr_TSL2569(TSL2569_DEFAULT_ADDRESS);           // 0x39
    // tsl.getAddr_TSL2569(TSL2569_DEFAULT_LOW);            // 0x29
    // tsl.getAddr_TSL2569(TSL2569_DEFAULT_HIGH);           // 0x49
...
void loop(void)
{
    ...
    // TSL2569 Light-to-Digital Converter Address
    ...
    if (error == 0)
    {
        Serial.println("Getting Light Data Readings from TSL2569");
        Serial.println(" ");
    ...
    {
        Serial.println("TSL2569 Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
