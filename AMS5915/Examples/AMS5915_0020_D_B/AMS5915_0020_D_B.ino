...
/*
        ...
        AMS5915_0020-D-B
        This code is designed to work with the AMS5915_I2CS_0020-D-B I2C Mini Module available from ControlEverything.com.
...
AMS5915 ams;
const float AMS5915_0020_D_B_P_MIN = -20.0;      // minimum pressure, millibar
const float AMS5915_0020_D_B_P_MAX = 20.0;       // maximum pressure, millibar
...
void loop(void)
{
    ...
    if (error == 0)
    {
        ams.Measure_PressureAndTemperature(AMS5915_0020_D_B_P_MIN, AMS5915_0020_D_B_P_MAX);
        float cTemp, fTemp, pressure, kPa, hg;

        Serial.println("Getting Readings from AMS5915_0020-D-B");
        Serial.println(" ");
    ...
    {
        Serial.println("AMS5915_0020-D-B Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
