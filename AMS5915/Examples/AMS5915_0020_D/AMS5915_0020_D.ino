...
/*
        ...
        AMS5915_0020-D
        This code is designed to work with the AMS5915_I2CS_0020-D I2C Mini Module available from ControlEverything.com.
...
AMS5915 ams;
const float AMS5915_0020_D_P_MIN = 0.0;     // minimum pressure, millibar
const float AMS5915_0020_D_P_MAX = 10.0;    // maximum pressure, millibar
...
void loop(void)
{
    ...
    if (error == 0)
    {
        ams.Measure_PressureAndTemperature(AMS5915_0020_D_P_MIN, AMS5915_0020_D_P_MAX);
        float cTemp, fTemp, pressure, kPa, hg;

        Serial.println("Getting Readings from AMS5915_0020-D");
        Serial.println(" ");
    ...
    {
        Serial.println("AMS5915_0020-D Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
