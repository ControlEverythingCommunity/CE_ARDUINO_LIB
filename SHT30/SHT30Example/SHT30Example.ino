...
void setup(void) 
{
    ...
    // sht.getAddr_SHT30(SHT30_ADDRESS_HIGH);   // 0x45
    ...
    // sht.setHeaterStatus(SHT30_CMD_HEATERDISABLE);      // Heater disable command
...
void loop(void)
{
    ...
    if (error == 0)
    {
        ...
        Serial.println("Getting Readings from SHT30");
        Serial.println(" ");
    ...
    {
        Serial.println("SHT30 Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
