...
/**************************************************************************/
/*
        Instantiates a new SHT30 class with appropriate properties
*/
/**************************************************************************/
void SHT30::getAddr_SHT30(uint8_t i2cAddress)
{
    sht_i2cAddress = i2cAddress;
    sht_conversionDelay = SHT30_CONVERSIONDELAY;
}
...
uint16_t SHT30::readStatus(void)
{
    ...
    writeRegister(sht_i2cAddress, SHT30_CMD_READSTATUS);
...
{
    // Resets the SHT30 with the RESET command
    writeRegister(sht_i2cAddress, SHT30_CMD_SOFTRESET);
    delay(sht_conversionDelay);
}
...
*/
/**************************************************************************/
void SHT30::setHeaterStatus(uint16_t heaterstatus)
{
...
*/
/**************************************************************************/
float SHT30::getTemperature(void)
{
...
*/
/**************************************************************************/
bool SHT30::Measure_TemperatureAndHumidity(void)
{
    uint8_t buffer[6];
    
    // Command to set high repeatability measurement with clock stretching enabled
    writeRegister(sht_i2cAddress, SHT30_MEAS_HIGHREP_STRETCH_EN);
    delay(sht_conversionDelay);
...
*/
/**************************************************************************/
uint8_t SHT30::CRC8(const uint8_t *idata, int len)
{
    /*
