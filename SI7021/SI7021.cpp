...
/**************************************************************************/
/*
        Instantiates a new SI7021 class with appropriate properties
*/
/**************************************************************************/
void SI7021::getAddr_SI7021(uint8_t i2cAddress)
{
    si_i2cAddress = i2cAddress;
    si_conversionDelay = SI7021_CONVERSIONDELAY;
}
...
{
    // Resets the SI7021 with the RESET command
    writeRegister8(si_i2cAddress, SI7021_CMD_RESET);
}
 ...
 */
/**************************************************************************/
void SI7021::setTempMode(siTempMode_t tempmode)
{
 ...
 */
/**************************************************************************/
siTempMode_t SI7021::getTempMode()
{
    return si_tempmode;
}
...
*/
/**************************************************************************/
void SI7021::setHumidityMode(siHumidityMode_t humiditymode)
{
...
*/
/**************************************************************************/
siHumidityMode_t SI7021::getHumidityMode()
{
...
*/
/**************************************************************************/
void SI7021::setResolution(siResolution_t resolution)
{
...
*/
/**************************************************************************/
siResolution_t SI7021::getResolution()
{
...
*/
/**************************************************************************/
void SI7021::setVoltage(siVoltage_t voltage)
{
    si_voltage = voltage;
}
...
*/
/**************************************************************************/
void SI7021::setHeaterStatus(siHeaterStatus_t heaterstatus)
{
...
*/
/**************************************************************************/
siHeaterStatus_t SI7021::getHeaterStatus()
{
...
*/
/**************************************************************************/
void SI7021::setHeaterCurrent(siHeaterCurrent_t heatercurrent)
{
...
*/
/**************************************************************************/
siHeaterCurrent_t SI7021::getHeaterCurrent()
{
...
float SI7021::Measure_Temperature()
{
    ...
    // Sending command to the User register 1 for SI7021
    writeRegister(si_i2cAddress, SI7021_CMD_WRITE_USER_1, tempControl);
    ...
    // Sending command to the Heater Control Register 3 for SI7021
    writeRegister(si_i2cAddress, SI7021_CMD_READ_HEATER_CTRL, heaterControl);
    ...
    // 16-bit unsigned results for the SI7021
 ...
 */
/**************************************************************************/
float SI7021::Measure_OldTemperature()
{
    // Set Measurement Resolution
    uint8_t tempControl = si_resolution;
    ...
    uint16_t rawTemperature;
    float temperature;
    writeRegister8(si_i2cAddress, SI7021_CMD_TEMP_PREV_RH);
    delay(si_conversionDelay);
    rawTemperature = readRegister16(si_i2cAddress);
