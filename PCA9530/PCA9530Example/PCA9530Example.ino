...
void setup(void)
{
    ...
    pca.getAddr_PCA9530(PCA9530_DEFAULT_ADDRESS);           // 0x60
...
void loop(void)
{
    ...
    if (error == 0)
    {
        Serial.println("Getting LED State Readings from PCA9530");
        Serial.println(" ");
        ...
        pca.setLEDSelector(PCA9530_REG_LS0_PWM0, PCA9530_REG_LS0_PWM0);
        delay(500);
    ...
    {
        Serial.println("PCA9530 Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
