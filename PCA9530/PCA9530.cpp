...
/**************************************************************************/
/*
        Instantiates a new PCA9530 class with appropriate properties
*/
/**************************************************************************/
void PCA9530::getAddr_PCA9530(uint8_t i2cAddress)
{
    pca_i2cAddress = i2cAddress;
    pca_conversionDelay = PCA9530_CONVERSIONDELAY;
...
*/
/**************************************************************************/
void PCA9530::setFreqPSC0(uint8_t period)
{
    writeRegister(pca_i2cAddress, PCA9530_REG_PSC0, period);
...
*/
/**************************************************************************/
void PCA9530::setPWM0(uint8_t dutycycle)
{
    writeRegister(pca_i2cAddress, PCA9530_REG_PWM0, dutycycle);
    delay(pca_conversionDelay);
}
...
*/
/**************************************************************************/
void PCA9530::setFreqPSC1(uint8_t period)
{
    writeRegister(pca_i2cAddress, PCA9530_REG_PSC1, period);
    delay(pca_conversionDelay);
}
 ...
 */
/**************************************************************************/
void PCA9530::setPWM1(uint8_t dutycycle)
{
    writeRegister(pca_i2cAddress, PCA9530_REG_PWM1, dutycycle);
    delay(pca_conversionDelay);
}
...
*/
/**************************************************************************/
void PCA9530::setLEDSelector(uint8_t LED1, uint8_t LED0)
{
    writeRegister(pca_i2cAddress, PCA9530_REG_LS0, LED1 << 2 | LED0);
    delay(pca_conversionDelay);
}
