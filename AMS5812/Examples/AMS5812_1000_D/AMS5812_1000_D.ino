...
AMS5812 ams;
const float AMS5812_1000_D_P_MIN = 0.0;     // minimum pressure, PSI
const float AMS5812_1000_D_P_MAX = 100.0;   // maximum pressure, PSI
const float AMS5812_1000_D_T_MIN = -25.0;   // minimum temperature, C
const float AMS5812_1000_D_T_MAX = 85.0;    // maximum temperature, C
...
void loop(void)
{
    ...
    if (error == 0)
    {
        ams.Measure_PressureAndTemperature(AMS5812_1000_D_P_MIN, AMS5812_1000_D_P_MAX, AMS5812_1000_D_T_MIN, AMS5812_1000_D_T_MAX);
        float cTemp, fTemp, pressure, mbar, kPa, hg;

        Serial.println("Getting Readings from AMS5812_1000-D");
        Serial.println(" ");
    ...
    {
        Serial.println("AMS5812_1000-D Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
