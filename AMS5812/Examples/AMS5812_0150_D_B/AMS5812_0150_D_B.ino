...
AMS5812 ams;
const float AMS5812_0150_D_B_P_MIN = -15.0;     // minimum pressure, PSI
const float AMS5812_0150_D_B_P_MAX = 15.0;      // maximum pressure, PSI
const float AMS5812_0150_D_B_T_MIN = -25.0;     // minimum temperature, C
const float AMS5812_0150_D_B_T_MAX = 85.0;      // maximum temperature, C
...
void loop(void)
{
    ...
    if (error == 0)
    {
        ams.Measure_PressureAndTemperature(AMS5812_0150_D_B_P_MIN, AMS5812_0150_D_B_P_MAX, AMS5812_0150_D_B_T_MIN, AMS5812_0150_D_B_T_MAX);
        float cTemp, fTemp, pressure, mbar, kPa, hg;

        Serial.println("Getting Readings from AMS5812_0150-D-B");
        Serial.println(" ");
    ...
    {
        Serial.println("AMS5812_0150-D-B Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
