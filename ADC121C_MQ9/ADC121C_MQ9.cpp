...
/**************************************************************************/
/*
        Instantiates a new ADC121C_MQ9 class with appropriate properties
*/
/**************************************************************************/
void ADC121C_MQ9::getAddr_ADC121C_MQ9(uint8_t i2cAddress)
{
    ADC121C_MQ9_i2cAddress = i2cAddress;
    ADC121C_MQ9_conversionDelay = ADC121C_MQ9_CONVERSIONDELAY;
}
...
*/
/**************************************************************************/
bool ADC121C_MQ9::getAlertStatus()
{
    // high order bit is the alert flag, mask off the rest
    bool alert = (readRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_CONVERSION) & 0x8000) ? true : false;
    
    if (alert)
    {
        // Read the alert low and high values
        // And set the appropriate member variables
        uint8_t status = readRegister8(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_ALERT_STATUS);
        // Under Range Alert Flag
        if (status & 0x01)
            ADC121C_MQ9_alertLow = true;
        else
            ADC121C_MQ9_alertLow = false;
        
        // Over Range Alert Flag
        if (status & 0x02)
            ADC121C_MQ9_alertHigh = true;
        else
            ADC121C_MQ9_alertHigh = false;
    }
...
*/
/**************************************************************************/
bool ADC121C_MQ9::alertLowTriggered()
{
    return ADC121C_MQ9_alertLow;
}
...
*/
/**************************************************************************/
bool ADC121C_MQ9::alertHighTriggered()
{
    return ADC121C_MQ9_alertHigh;
}
...
*/
/**************************************************************************/
void ADC121C_MQ9::clearAlertStatus()
{
    // Zero out both the low and high alert flags
    uint8_t status = 0x03;
    writeRegister8(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_ALERT_STATUS, status);
...
*/
/**************************************************************************/
void ADC121C_MQ9::setCycleTime(ADC121C_MQ9CycleTime_t cycletime)
{
    ADC121C_MQ9_cycletime = cycletime;
}
...
*/
/**************************************************************************/
ADC121C_MQ9CycleTime_t ADC121C_MQ9::getCycleTime()
{
    return ADC121C_MQ9_cycletime;
}
...
*/
/**************************************************************************/
void ADC121C_MQ9::setAlertHold(ADC121C_MQ9AlertHold_t alerthold)
{
    ADC121C_MQ9_alerthold = alerthold;
}
...
*/
/**************************************************************************/
ADC121C_MQ9AlertHold_t ADC121C_MQ9::getAlertHold()
{
    return ADC121C_MQ9_alerthold;
}
...
*/
/**************************************************************************/
void ADC121C_MQ9::setAlertFlag(ADC121C_MQ9AlertFlag_t alertflag)
{
    ADC121C_MQ9_alertflag = alertflag;
}
...
*/
/**************************************************************************/
ADC121C_MQ9AlertFlag_t ADC121C_MQ9::getAlertFlag()
{
    return ADC121C_MQ9_alertflag;
}
...
*/
/**************************************************************************/
void ADC121C_MQ9::setAlertPin(ADC121C_MQ9AlertPin_t alertpin)
{
    ADC121C_MQ9_alertpin = alertpin;
}
...
*/
/**************************************************************************/
ADC121C_MQ9AlertPin_t ADC121C_MQ9::getAlertPin()
{
    return ADC121C_MQ9_alertpin;
}
...
*/
/**************************************************************************/
void ADC121C_MQ9::setPolarity(ADC121C_MQ9Polarity_t polarity)
{
    ADC121C_MQ9_polarity = polarity;
}
...
*/
/**************************************************************************/
ADC121C_MQ9Polarity_t ADC121C_MQ9::getPolarity()
{
    return ADC121C_MQ9_polarity;
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::setAlertLowLimit(uint16_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0x0FFF;
    return writeRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_LOW_LIMIT, limit);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::setAlertHighLimit(uint16_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0x0FFF;
    return writeRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_HIGH_LIMIT, limit);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::setHysteresis(uint16_t hysteresis)
{
    // mask off the invalid bits in case they were set
    hysteresis &= 0x0FFF;
    return writeRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_HYSTERESIS, hysteresis);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::getLowestConversion()
{
    return readRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_LOWCONV);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::getHighestConversion()
{
    return readRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_HIGHCONV);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::clearLowestConversion()
{
    uint16_t lowClear = 0x0FFF;
    return writeRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_LOWCONV, lowClear);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::clearHighestConversion()
{
    uint16_t highClear = 0x0000;
    return writeRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_HIGHCONV, highClear);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ9::Measure_Voltage()
{
    // Start with default values
    // Set the Cycle Time
    uint8_t config = ADC121C_MQ9_cycletime;
    
    // Set the Alert Hold Status
    config |= ADC121C_MQ9_alerthold;
    
    // Set the Alert Flag Enable Status
    config |= ADC121C_MQ9_alertflag;
    
    // Set the Alert Pin Enable Status
    config |= ADC121C_MQ9_alertpin;
    
    // Set the Polarity
    config |= ADC121C_MQ9_polarity;

    // Write config register to the ADC
    writeRegister8(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_CONFIG, config);

    // Wait for the conversion to complete
    delay(ADC121C_MQ9_conversionDelay);

    // Read the conversion result
    // 12-bit unsigned result for the ADC121C_MQ9
    return readRegister(ADC121C_MQ9_i2cAddress, ADC121C_MQ9_REG_POINTER_CONVERSION);
}

/**************************************************************************/
/*
        This function returns the sensor resistance in clear air (Ro).
        Ro means Resistance of Sensor at 1000ppm of LPG
*/
/**************************************************************************/
void ADC121C_MQ9::Calibration(float Ro)
{
    _Ro = Ro;
...
*/
/**************************************************************************/
float ADC121C_MQ9::Measure_Resistance(int rawadc)
{
...
*/
/**************************************************************************/
float ADC121C_MQ9::Measure_Scaled(float a, float b)
{
...
*/
/**************************************************************************/
float ADC121C_MQ9::Measure_RatioRsRo()
{
 ...
 */
/**************************************************************************/
float ADC121C_MQ9::Measure_LPG(float a, float b)
{
...
*/
/**************************************************************************/
float ADC121C_MQ9::Measure_Methane(float a, float b)
{
    return (float)Measure_Scaled(a, b);
}
...
*/
/**************************************************************************/
float ADC121C_MQ9::Measure_CarbonMonoxide(float a, float b)
{
    return (float)Measure_Scaled(a, b);
}
