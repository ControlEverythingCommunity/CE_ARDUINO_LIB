...
void setup(void)
{
    ...
    lis.getAddr_LIS33DE(LIS33DE_DEFAULT_ADDRESS);        // 0x1C
    // lis.getAddr_LIS33DE(LIS33DE_ADDRESS_UPDATED);     // 0x1D
...
void loop(void)
{
    ...
    if (error == 0)
    {
        Serial.println("Getting Acceleration Readings from LIS33DE");
        Serial.println(" ");
    ...
    {
        Serial.println("LIS33DE Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
