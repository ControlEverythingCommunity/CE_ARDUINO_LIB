...
/**************************************************************************/
/*
        Instantiates a new ADC121C_MQ8 class with appropriate properties
*/
/**************************************************************************/
void ADC121C_MQ8::getAddr_ADC121C_MQ8(uint8_t i2cAddress)
{
    ADC121C_MQ8_i2cAddress = i2cAddress;
    ADC121C_MQ8_conversionDelay = ADC121C_MQ8_CONVERSIONDELAY;
}
...
*/
/**************************************************************************/
bool ADC121C_MQ8::getAlertStatus()
{
    // high order bit is the alert flag, mask off the rest
    bool alert = (readRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_CONVERSION) & 0x8000) ? true : false;
    
    if (alert)
    {
        // Read the alert low and high values
        // And set the appropriate member variables
        uint8_t status = readRegister8(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_ALERT_STATUS);
        // Under Range Alert Flag
        if (status & 0x01)
            ADC121C_MQ8_alertLow = true;
        else
            ADC121C_MQ8_alertLow = false;
        
        // Over Range Alert Flag
        if (status & 0x02)
            ADC121C_MQ8_alertHigh = true;
        else
            ADC121C_MQ8_alertHigh = false;
    }
...
*/
/**************************************************************************/
bool ADC121C_MQ8::alertLowTriggered()
{
    return ADC121C_MQ8_alertLow;
}
...
*/
/**************************************************************************/
bool ADC121C_MQ8::alertHighTriggered()
{
    return ADC121C_MQ8_alertHigh;
}
...
*/
/**************************************************************************/
void ADC121C_MQ8::clearAlertStatus()
{
    // Zero out both the low and high alert flags
    uint8_t status = 0x03;
    writeRegister8(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_ALERT_STATUS, status);
...
*/
/**************************************************************************/
void ADC121C_MQ8::setCycleTime(ADC121C_MQ8CycleTime_t cycletime)
{
    ADC121C_MQ8_cycletime = cycletime;
}
...
*/
/**************************************************************************/
ADC121C_MQ8CycleTime_t ADC121C_MQ8::getCycleTime()
{
    return ADC121C_MQ8_cycletime;
}
...
*/
/**************************************************************************/
void ADC121C_MQ8::setAlertHold(ADC121C_MQ8AlertHold_t alerthold)
{
    ADC121C_MQ8_alerthold = alerthold;
}
...
*/
/**************************************************************************/
ADC121C_MQ8AlertHold_t ADC121C_MQ8::getAlertHold()
{
    return ADC121C_MQ8_alerthold;
}
...
*/
/**************************************************************************/
void ADC121C_MQ8::setAlertFlag(ADC121C_MQ8AlertFlag_t alertflag)
{
    ADC121C_MQ8_alertflag = alertflag;
}
...
*/
/**************************************************************************/
ADC121C_MQ8AlertFlag_t ADC121C_MQ8::getAlertFlag()
{
    return ADC121C_MQ8_alertflag;
}
...
*/
/**************************************************************************/
void ADC121C_MQ8::setAlertPin(ADC121C_MQ8AlertPin_t alertpin)
{
    ADC121C_MQ8_alertpin = alertpin;
}
...
*/
/**************************************************************************/
ADC121C_MQ8AlertPin_t ADC121C_MQ8::getAlertPin()
{
    return ADC121C_MQ8_alertpin;
}
...
*/
/**************************************************************************/
void ADC121C_MQ8::setPolarity(ADC121C_MQ8Polarity_t polarity)
{
    ADC121C_MQ8_polarity = polarity;
}
...
*/
/**************************************************************************/
ADC121C_MQ8Polarity_t ADC121C_MQ8::getPolarity()
{
    return ADC121C_MQ8_polarity;
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::setAlertLowLimit(uint16_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0x0FFF;
    return writeRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_LOW_LIMIT, limit);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::setAlertHighLimit(uint16_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0x0FFF;
    return writeRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_HIGH_LIMIT, limit);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::setHysteresis(uint16_t hysteresis)
{
    // mask off the invalid bits in case they were set
    hysteresis &= 0x0FFF;
    return writeRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_HYSTERESIS, hysteresis);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::getLowestConversion()
{
    return readRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_LOWCONV);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::getHighestConversion()
{
    return readRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_HIGHCONV);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::clearLowestConversion()
{
    uint16_t lowClear = 0x0FFF;
    return writeRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_LOWCONV, lowClear);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::clearHighestConversion()
{
    uint16_t highClear = 0x0000;
    return writeRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_HIGHCONV, highClear);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ8::Measure_Voltage()
{
    // Start with default values
    // Set the Cycle Time
    uint8_t config = ADC121C_MQ8_cycletime;
    
    // Set the Alert Hold Status
    config |= ADC121C_MQ8_alerthold;
    
    // Set the Alert Flag Enable Status
    config |= ADC121C_MQ8_alertflag;
    
    // Set the Alert Pin Enable Status
    config |= ADC121C_MQ8_alertpin;
    
    // Set the Polarity
    config |= ADC121C_MQ8_polarity;

    // Write config register to the ADC
    writeRegister8(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_CONFIG, config);

    // Wait for the conversion to complete
    delay(ADC121C_MQ8_conversionDelay);

    // Read the conversion result
    // 12-bit unsigned result for the ADC121C_MQ8
    return readRegister(ADC121C_MQ8_i2cAddress, ADC121C_MQ8_REG_POINTER_CONVERSION);
}
...
*/
/**************************************************************************/
void ADC121C_MQ8::Calibration(float Ro)
{
    _Ro = Ro;
...
*/
/**************************************************************************/
void ADC121C_MQ8::Calibration()
{
    float Ro = 0;
    for (int i = 0; i < ADC121C_MQ8_SAMPLE_TIMES; i++)
    {
        Ro += Measure_Resistance(Measure_Voltage());
        delay(ADC121C_MQ8_SAMPLE_INTERVAL);
    }
    Ro = Ro/ADC121C_MQ8_SAMPLE_TIMES;
...
*/
/**************************************************************************/
float ADC121C_MQ8::Measure_Resistance(int rawadc)
{
...
float ADC121C_MQ8::Measure_Rs()
{
    ...
    Rs = Rs / ADC121C_MQ8_SAMPLE_TIMES;
    return Rs;
}
...
*/
/**************************************************************************/
float ADC121C_MQ8::Measure_Scaled(float a, float b)
{
...
*/
/**************************************************************************/
float ADC121C_MQ8::Measure_RatioRsRo()
{
 ...
 */
/**************************************************************************/
float ADC121C_MQ8::Measure_Hydrogen(float a, float b)
{
