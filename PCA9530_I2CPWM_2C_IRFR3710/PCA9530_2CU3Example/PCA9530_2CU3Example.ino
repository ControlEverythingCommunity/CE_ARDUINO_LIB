...
void setup(void)
{
    ...
    pca.getAddr_PCA9530_2CU3(PCA9530_2CU3_DEFAULT_ADDRESS);           // 0x60
...
void loop(void)
{
    ...
    if (error == 0)
    {
        Serial.println("Getting LED State Readings from PCA9530_2CU3");
        Serial.println(" ");
        ...
        pca.setLEDSelector(PCA9530_2CU3_REG_LS0_PWM0, PCA9530_2CU3_REG_LS0_PWM0);
        delay(500);
    ...
    {
        Serial.println("PCA9530_2CU3 Disconnected!");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
