...
void setup(void) 
{
    ...
    mcp.getAddr_MCP9808(MCP9808_DEFAULT_ADDRESS);           // 0x18, 0011 000
    // mcp.getAddr_MCP9808(MCP9808_ADDRESS_A2A1A0_001);     // 0x19, 0011 001
    // mcp.getAddr_MCP9808(MCP9808_ADDRESS_A2A1A0_010);     // 0x1A, 0011 010
    // mcp.getAddr_MCP9808(MCP9808_ADDRESS_A2A1A0_011);     // 0x1B, 0011 011
    // mcp.getAddr_MCP9808(MCP9808_ADDRESS_A2A1A0_100);     // 0x1C, 0011 100
    // mcp.getAddr_MCP9808(MCP9808_ADDRESS_A2A1A0_101);     // 0x1D, 0011 101
    // mcp.getAddr_MCP9808(MCP9808_ADDRESS_A2A1A0_110);     // 0x1E, 0011 110
    // mcp.getAddr_MCP9808(MCP9808_ADDRESS_A2A1A0_111);     // 0x1F, 0011 111
...
void loop(void)
{
    ...
    {
        int16_t temp;
        Serial.println("Getting Temperature Readings from MCP9808");
        Serial.println(" ");
    ...
    {
        Serial.println("MCP9808 Disconnected !");
        Serial.println(" ");
        Serial.println("        ************        ");
        Serial.println(" ");
    }
