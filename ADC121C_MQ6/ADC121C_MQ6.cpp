...
/**************************************************************************/
/*
        Instantiates a new ADC121C_MQ6 class with appropriate properties
*/
/**************************************************************************/
void ADC121C_MQ6::getAddr_ADC121C_MQ6(uint8_t i2cAddress)
{
    ADC121C_MQ6_i2cAddress = i2cAddress;
    ADC121C_MQ6_conversionDelay = ADC121C_MQ6_CONVERSIONDELAY;
}
...
*/
/**************************************************************************/
bool ADC121C_MQ6::getAlertStatus()
{
    // high order bit is the alert flag, mask off the rest
    bool alert = (readRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_CONVERSION) & 0x8000) ? true : false;
    
    if (alert)
    {
        // Read the alert low and high values
        // And set the appropriate member variables
        uint8_t status = readRegister8(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_ALERT_STATUS);
        // Under Range Alert Flag
        if (status & 0x01)
            ADC121C_MQ6_alertLow = true;
        else
            ADC121C_MQ6_alertLow = false;
        
        // Over Range Alert Flag
        if (status & 0x02)
            ADC121C_MQ6_alertHigh = true;
        else
            ADC121C_MQ6_alertHigh = false;
    }
...
*/
/**************************************************************************/
bool ADC121C_MQ6::alertLowTriggered()
{
    return ADC121C_MQ6_alertLow;
}
...
*/
/**************************************************************************/
bool ADC121C_MQ6::alertHighTriggered()
{
    return ADC121C_MQ6_alertHigh;
}
...
*/
/**************************************************************************/
void ADC121C_MQ6::clearAlertStatus()
{
    // Zero out both the low and high alert flags
    uint8_t status = 0x03;
    writeRegister8(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_ALERT_STATUS, status);
...
*/
/**************************************************************************/
void ADC121C_MQ6::setCycleTime(ADC121C_MQ6CycleTime_t cycletime)
{
    ADC121C_MQ6_cycletime = cycletime;
}
...
*/
/**************************************************************************/
ADC121C_MQ6CycleTime_t ADC121C_MQ6::getCycleTime()
{
    return ADC121C_MQ6_cycletime;
}
...
*/
/**************************************************************************/
void ADC121C_MQ6::setAlertHold(ADC121C_MQ6AlertHold_t alerthold)
{
    ADC121C_MQ6_alerthold = alerthold;
}
...
*/
/**************************************************************************/
ADC121C_MQ6AlertHold_t ADC121C_MQ6::getAlertHold()
{
    return ADC121C_MQ6_alerthold;
}
...
*/
/**************************************************************************/
void ADC121C_MQ6::setAlertFlag(ADC121C_MQ6AlertFlag_t alertflag)
{
    ADC121C_MQ6_alertflag = alertflag;
}
...
*/
/**************************************************************************/
ADC121C_MQ6AlertFlag_t ADC121C_MQ6::getAlertFlag()
{
    return ADC121C_MQ6_alertflag;
}
...
*/
/**************************************************************************/
void ADC121C_MQ6::setAlertPin(ADC121C_MQ6AlertPin_t alertpin)
{
    ADC121C_MQ6_alertpin = alertpin;
}
...
*/
/**************************************************************************/
ADC121C_MQ6AlertPin_t ADC121C_MQ6::getAlertPin()
{
    return ADC121C_MQ6_alertpin;
}
...
*/
/**************************************************************************/
void ADC121C_MQ6::setPolarity(ADC121C_MQ6Polarity_t polarity)
{
    ADC121C_MQ6_polarity = polarity;
}
...
*/
/**************************************************************************/
ADC121C_MQ6Polarity_t ADC121C_MQ6::getPolarity()
{
    return ADC121C_MQ6_polarity;
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::setAlertLowLimit(uint16_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0x0FFF;
    return writeRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_LOW_LIMIT, limit);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::setAlertHighLimit(uint16_t limit)
{
    // mask off the invalid bits in case they were set
    limit &= 0x0FFF;
    return writeRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_HIGH_LIMIT, limit);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::setHysteresis(uint16_t hysteresis)
{
    // mask off the invalid bits in case they were set
    hysteresis &= 0x0FFF;
    return writeRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_HYSTERESIS, hysteresis);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::getLowestConversion()
{
    return readRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_LOWCONV);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::getHighestConversion()
{
    return readRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_HIGHCONV);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::clearLowestConversion()
{
    uint16_t lowClear = 0x0FFF;
    return writeRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_LOWCONV, lowClear);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::clearHighestConversion()
{
    uint16_t highClear = 0x0000;
    return writeRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_HIGHCONV, highClear);
}
...
*/
/**************************************************************************/
uint16_t ADC121C_MQ6::Measure_Voltage()
{
    // Start with default values
    // Set the Cycle Time
    uint8_t config = ADC121C_MQ6_cycletime;
    
    // Set the Alert Hold Status
    config |= ADC121C_MQ6_alerthold;
    
    // Set the Alert Flag Enable Status
    config |= ADC121C_MQ6_alertflag;
    
    // Set the Alert Pin Enable Status
    config |= ADC121C_MQ6_alertpin;
    
    // Set the Polarity
    config |= ADC121C_MQ6_polarity;

    // Write config register to the ADC
    writeRegister8(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_CONFIG, config);

    // Wait for the conversion to complete
    delay(ADC121C_MQ6_conversionDelay);

    // Read the conversion result
    // 12-bit unsigned result for the ADC121C_MQ6
    return readRegister(ADC121C_MQ6_i2cAddress, ADC121C_MQ6_REG_POINTER_CONVERSION);
}
...
*/
/**************************************************************************/
void ADC121C_MQ6::Calibration(float Ro)
{
    _Ro = Ro;
...
*/
/**************************************************************************/
void ADC121C_MQ6::Calibration()
{
    float Ro = 0;
    for (int i = 0; i < ADC121C_MQ6_SAMPLE_TIMES; i++)
    {
        Ro += Measure_Resistance(Measure_Voltage());
        delay(ADC121C_MQ6_SAMPLE_INTERVAL);
    }
    Ro = Ro/ADC121C_MQ6_SAMPLE_TIMES;
...
*/
/**************************************************************************/
float ADC121C_MQ6::Measure_Resistance(int rawadc)
{
...
float ADC121C_MQ6::Measure_Rs()
{
    ...
    Rs = Rs / ADC121C_MQ6_SAMPLE_TIMES;
    return Rs;
}
...
*/
/**************************************************************************/
float ADC121C_MQ6::Measure_Scaled(float a, float b)
{
...
*/
/**************************************************************************/
float ADC121C_MQ6::Measure_RatioRsRo()
{
 ...
 */
/**************************************************************************/
float ADC121C_MQ6::Measure_LPG(float a, float b)
{
