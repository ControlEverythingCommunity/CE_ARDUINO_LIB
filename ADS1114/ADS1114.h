...
/**************************************************************************
    I2C ADDRESS/BITS
**************************************************************************/
    #define ADS1114_DEFAULT_ADDRESS         (0x48)    // 1001 000 (ADDR = GND)
    #define ADS1114_VDD_ADDRESS             (0x49)    // 1001 001 (ADDR = VDD)
    #define ADS1114_SDA_ADDRESS             (0x4A)    // 1001 010 (ADDR = SDA)
    #define ADS1114_SCL_ADDRESS             (0x4B)    // 1001 011 (ADDR = SCL)

/**************************************************************************
    CONVERSION DELAY (in mS)
**************************************************************************/
    #define ADS1114_CONVERSIONDELAY         (100)
...
/**************************************************************************
    CONFIG REGISTER
**************************************************************************/
    #define ADS1114_REG_CONFIG_OS_MASK      (0x8000)    // Operational status/single-shot conversion start
    #define ADS1114_REG_CONFIG_OS_NOEFFECT  (0x0000)    // Write: Bit = 0 No effect
    #define ADS1114_REG_CONFIG_OS_SINGLE    (0x8000)    // Write: Bit = 1 Begin a single conversion
    #define ADS1114_REG_CONFIG_OS_BUSY      (0x0000)    // Read: Bit = 0 Device is performing a conversion
    #define ADS1114_REG_CONFIG_OS_NOTBUSY   (0x8000)    // Read: Bit = 1 Device is not performing a conversion

    #define ADS1114_REG_CONFIG_MUX_MASK     (0x7000)    // Input multiplexer configuration
    #define ADS1114_REG_CONFIG_MUX_DIFF_0_1 (0x0000)    // Differential P = AIN0, N = AIN1 (default)
    #define ADS1114_REG_CONFIG_MUX_SINGLE_0 (0x4000)    // Single-ended P = AIN0, N = GND
    #define ADS1114_REG_CONFIG_MUX_SINGLE_1 (0x5000)    // Single-ended P = AIN1, N = GND

    #define ADS1114_REG_CONFIG_PGA_MASK     (0x0E00)    // Programmable gain amplifier configuration
    ...
    #define ADS1114_REG_CONFIG_MODE_MASK    (0x0100)    // Device operating mode
    ...
    #define ADS1114_REG_CONFIG_DR_MASK      (0x00E0)    // Data rate
    #define ADS1114_REG_CONFIG_DR_8SPS      (0x0000)    // 8 samples per second
    #define ADS1114_REG_CONFIG_DR_16SPS     (0x0020)    // 16 samples per second
    #define ADS1114_REG_CONFIG_DR_32SPS     (0x0040)    // 32 samples per second
    #define ADS1114_REG_CONFIG_DR_64SPS     (0x0060)    // 64 samples per second
    #define ADS1114_REG_CONFIG_DR_128SPS    (0x0080)    // 128 samples per second (default)
    #define ADS1114_REG_CONFIG_DR_250SPS    (0x00A0)    // 250 samples per second
    #define ADS1114_REG_CONFIG_DR_475SPS    (0x00C0)    // 475 samples per second
    #define ADS1114_REG_CONFIG_DR_860SPS    (0x00E0)    // 860 samples per second

    #define ADS1114_REG_CONFIG_CMODE_MASK   (0x0010)    // Comparator mode
    ...
    #define ADS1114_REG_CONFIG_CPOL_MASK    (0x0008)    // Comparator polarity
    ...
    #define ADS1114_REG_CONFIG_CLAT_MASK    (0x0004)    // Latching comparator
    ...
    #define ADS1114_REG_CONFIG_CQUE_MASK    (0x0003)    // Comparator queue and disable
...
typedef enum
{
    OSMODE_SINGLE   = ADS1114_REG_CONFIG_OS_SINGLE,
    OSMODE_BUSY     = ADS1114_REG_CONFIG_OS_BUSY,
    OSMODE_NOTBUSY  = ADS1114_REG_CONFIG_OS_NOTBUSY
...
typedef enum
{
    MODE_CONTIN     = ADS1114_REG_CONFIG_MODE_CONTIN,
    MODE_SINGLE     = ADS1114_REG_CONFIG_MODE_SINGLE
} adsMode_t;

typedef enum
{
    RATE_8          = ADS1114_REG_CONFIG_DR_8SPS,
    RATE_16         = ADS1114_REG_CONFIG_DR_16SPS,
    RATE_32         = ADS1114_REG_CONFIG_DR_32SPS,
    RATE_64         = ADS1114_REG_CONFIG_DR_64SPS,
    RATE_128        = ADS1114_REG_CONFIG_DR_128SPS,
    RATE_250        = ADS1114_REG_CONFIG_DR_250SPS,
    RATE_475        = ADS1114_REG_CONFIG_DR_475SPS,
    RATE_860        = ADS1114_REG_CONFIG_DR_860SPS
} adsRate_t;

typedef enum
{
    COMPMODE_TRAD   = ADS1114_REG_CONFIG_CMODE_TRAD,
    COMPMODE_WINDOW = ADS1114_REG_CONFIG_CMODE_WINDOW
} adsCompMode_t;

typedef enum
{
    COMPPOL_LOW     = ADS1114_REG_CONFIG_CPOL_ACTVLOW,
    COMPPOL_HIGH    = ADS1114_REG_CONFIG_CPOL_ACTVHI
} adsCompPol_t;

typedef enum
{
    COMPLAT_NONLAT  = ADS1114_REG_CONFIG_CLAT_NONLAT,
    COMPLAT_LATCH   = ADS1114_REG_CONFIG_CLAT_LATCH
} adsCompLat_t;

typedef enum
{
    COMPQUE_ONE     = ADS1114_REG_CONFIG_CQUE_1CONV,
    COMPQUE_TWO     = ADS1114_REG_CONFIG_CQUE_2CONV,
    COMPQUE_FOUR    = ADS1114_REG_CONFIG_CQUE_4CONV,
    COMPQUE_NONE    = ADS1114_REG_CONFIG_CQUE_NONE
} adsCompQue_t;
...
class ADS1114
{
    ...
    public:
        ...
        void getAddr_ADS1114(uint8_t i2cAddress);
        void begin(void);
