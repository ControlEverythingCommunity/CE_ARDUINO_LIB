...
{
    Wire.beginTransmission(i2cAddress);
    i2cwrite(ADS1114_REG_POINTER_CONVERT);
    Wire.endTransmission();
...
/**************************************************************************/
/*
        Instantiates a new ADS1114 class with appropriate properties
*/
/**************************************************************************/
void ADS1114::getAddr_ADS1114(uint8_t i2cAddress)
{
    ads_i2cAddress = i2cAddress;
    ads_conversionDelay = ADS1114_CONVERSIONDELAY;
}
...
*/
/**************************************************************************/
void ADS1114::setOSMode(adsOSMode_t osmode)
{
    ads_osmode = osmode;
}
...
*/
/**************************************************************************/
void ADS1114::setGain(adsGain_t gain)
{
    ads_gain = gain;
}
...
/*
        ...
        This controls the current operational mode of the ADS1114
*/
/**************************************************************************/
void ADS1114::setMode(adsMode_t mode)
{
    ads_mode = mode;
}
...
*/
/**************************************************************************/
void ADS1114::setRate(adsRate_t rate)
{
    ads_rate = rate;
}
...
*/
/**************************************************************************/
void ADS1114::setCompMode(adsCompMode_t compmode)
{
...
*/
/**************************************************************************/
adsCompMode_t ADS1114::getCompMode()
{
    return ads_compmode;
}
...
*/
/**************************************************************************/
void ADS1114::setCompPol(adsCompPol_t comppol)
{
    ads_comppol = comppol;
}
...
*/
/**************************************************************************/
adsCompPol_t ADS1114::getCompPol()
{
    return ads_comppol;
}
...
*/
/**************************************************************************/
void ADS1114::setCompLat(adsCompLat_t complat)
{
    ads_complat = complat;
}
...
*/
/**************************************************************************/
adsCompLat_t ADS1114::getCompLat()
{
    return ads_complat;
}
...
*/
/**************************************************************************/
void ADS1114::setCompQue(adsCompQue_t compque)
{
    ads_compque = compque;
}
...
*/
/**************************************************************************/
adsCompQue_t ADS1114::getCompQue()
{
    return ads_compque;
}
...
*/
/**************************************************************************/
void ADS1114::setLowThreshold(int16_t threshold)
{
    ads_lowthreshold = threshold;
    writeRegister(ads_i2cAddress, ADS1114_REG_POINTER_LOWTHRESH, ads_lowthreshold);
}
...
*/
/**************************************************************************/
int16_t ADS1114::getLowThreshold()
{
...
*/
/**************************************************************************/
void ADS1114::setHighThreshold(int16_t threshold)
{
    ads_highthreshold = threshold;
    writeRegister(ads_i2cAddress, ADS1114_REG_POINTER_HITHRESH, ads_highthreshold);
}
...
*/
/**************************************************************************/
int16_t ADS1114::getHighThreshold()
{
...
/*
        ...
        ADS1114 can only accept positive voltages
*/
/**************************************************************************/
uint16_t ADS1114::Measure_SingleEnded(uint8_t channel)
{
    if (channel > 1)
    {
        return 0;
    ...
    writeRegister(ads_i2cAddress, ADS1114_REG_POINTER_CONFIG, config);

    // Wait for the conversion to complete
    delay(ads_conversionDelay);

    // Read the conversion results
    // 16-bit unsigned results for the ADS1114
    return readRegister(ads_i2cAddress, ADS1114_REG_POINTER_CONVERT);
}
...
*/
/**************************************************************************/
int16_t ADS1114::Measure_Differential(uint8_t channel)
{
    // Start with default values
    uint16_t config =   ADS1114_REG_CONFIG_CQUE_NONE    |   // Disable the comparator (default val)
                        ADS1114_REG_CONFIG_CLAT_NONLAT  |   // Non-latching (default val)
    ...
    // Read the conversion results
    uint16_t raw_adc = readRegister(ads_i2cAddress, ADS1114_REG_POINTER_CONVERT);
...
*/
/**************************************************************************/
int16_t ADS1114::Comparator_SingleEnded(uint8_t channel)
{
    // Start with default values
    uint16_t config;
...
*/
/**************************************************************************/
int16_t ADS1114::Comparator_Differential(uint8_t channel)
{
    // Start with default values
    uint16_t config;
