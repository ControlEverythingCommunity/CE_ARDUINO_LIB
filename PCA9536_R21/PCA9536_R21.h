...
/**************************************************************************
    I2C ADDRESS/BITS
**************************************************************************/
    #define PCA9536_R21_DEFAULT_ADDRESS                         (0x41)

/**************************************************************************
    CONVERSION DELAY (in mS)
**************************************************************************/
    #define PCA9536_R21_CONVERSIONDELAY                         (100)

/**************************************************************************
    DIGITAL COLOR, PROXIMITY MODULE REGISTERS
**************************************************************************/
    #define PCA9536_R21_NUM_BYTES                               (0x01)      // No of Bytes
    #define PCA9536_R21_ALL_INPUT                               (0xFF)      // All Pins are Inputs
    #define PCA9536_R21_ALL_OUTPUT                              (0x00)      // All Pins are Outputs
    #define PCA9536_R21_ALL_LOW                                 (0x00)      // All Pins are Low
    #define PCA9536_R21_ALL_HIGH                                (0xFF)      // All Pins are High
    #define PCA9536_R21_ALL_NON_INVERTED                        (0x00)      // All Pins are Non-Inverted
    #define PCA9536_R21_ALL_INVERTED                            (0xFF)      // All Pins are Inverted

typedef enum
{
    PCA9536_R21_REG_INPUT           = 0,
    PCA9536_R21_REG_OUTPUT          = 1,
    PCA9536_R21_REG_POLARITY        = 2,
    PCA9536_R21_REG_CONFIG          = 3
    
} pcaCommand_t;

typedef enum
{
    PCA9536_R21_OUTPUT_PIN0         = 0,
    PCA9536_R21_OUTPUT_PIN1         = 1,
    PCA9536_R21_OUTPUT_PIN2         = 2,
    PCA9536_R21_OUTPUT_PIN3         = 3
    
} pcaPin_t;

typedef enum
{
    PCA9536_R21_MODE_OUTPUT         = 0,
    PCA9536_R21_MODE_INPUT          = 1
    
} pcaMode_t;

typedef enum
{
    PCA9536_R21_STATE_LOW           = 0,
    PCA9536_R21_STATE_HIGH          = 1
    
} pcaState_t;

typedef enum
{
    PCA9536_R21_STATE_NON_INVERTED  = 0,
    PCA9536_R21_STATE_INVERTED      = 1
...
class PCA9536_R21
{
    ...
    public:
        ...
        void getAddr_PCA9536_R21(uint8_t i2cAddress);
        uint8_t begin();
        void Reset();
