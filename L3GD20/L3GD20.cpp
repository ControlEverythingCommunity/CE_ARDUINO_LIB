...
/**************************************************************************/
/*
        Instantiates a new L3GD20 class with appropriate properties (Gyroscope Address)
*/
/**************************************************************************/
void L3GD20::getAddr_L3GD20(uint8_t i2cAddress)
{
...
bool L3GD20::begin()
{
    ...
    uint8_t Gdevid = readRegister(l3g_i2cAddress, L3GD20_REG_GYRO_WHO_AM_I);
    if (Gdevid != L3GD20_GYRO_DEV_ID)
        return false;
...
*/
/**************************************************************************/
void L3GD20::setGyroDataRate(l3gGyroDataRate_t gyrodatarate)
{
...
*/
/**************************************************************************/
l3gGyroDataRate_t L3GD20::getGyroDataRate()
{
...
*/
/**************************************************************************/
void L3GD20::setGyroMode(l3gGyroMode_t gyromode)
{
...
*/
/**************************************************************************/
l3gGyroMode_t L3GD20::getGyroMode()
{
    return l3g_gyromode;
}
...
*/
/**************************************************************************/
void L3GD20::setGyroZen(l3gGyroZen_t gyrozen)
{
    l3g_gyrozen = gyrozen;
}
...
*/
/**************************************************************************/
l3gGyroZen_t L3GD20::getGyroZen()
{
    return l3g_gyrozen;
}
...
*/
/**************************************************************************/
void L3GD20::setGyroYen(l3gGyroYen_t gyroyen)
{
    l3g_gyroyen = gyroyen;
}
...
*/
/**************************************************************************/
l3gGyroYen_t L3GD20::getGyroYen()
{
    return l3g_gyroyen;
}
...
*/
/**************************************************************************/
void L3GD20::setGyroXen(l3gGyroXen_t gyroxen)
{
    l3g_gyroxen = gyroxen;
}
...
*/
/**************************************************************************/
l3gGyroXen_t L3GD20::getGyroXen()
{
    return l3g_gyroxen;
}
...
*/
/**************************************************************************/
void L3GD20::setGyroBlockData(l3gGyroBlockData_t gyroblockdata)
{
...
*/
/**************************************************************************/
l3gGyroBlockData_t L3GD20::getGyroBlockData()
{
...
*/
/**************************************************************************/
void L3GD20::setGyroEndianData(l3gGyroEndianData_t gyroendiandata)
{
...
*/
/**************************************************************************/
l3gGyroEndianData_t L3GD20::getGyroEndianData()
{
...
*/
/**************************************************************************/
void L3GD20::setGyroScale(l3gGyroScale_t gyroscale)
{
...
*/
/**************************************************************************/
l3gGyroScale_t L3GD20::getGyroScale()
{
...
*/
/**************************************************************************/
void L3GD20::setGyroSPIWire(l3gGyroSPIWire_t gyrospiwire)
{
...
*/
/**************************************************************************/
l3gGyroSPIWire_t L3GD20::getGyroSPIWire()
{
...
*/
/**************************************************************************/
void L3GD20::setUpGyroscope(void)
{
    ...
    */
    ...
    uint8_t config1 =   L3GD20_REG_GYRO_CTRL_REG1_PD_NORMAL           |   // Normal Mode
                        L3GD20_REG_GYRO_CTRL_REG1_ZEN_ENABLE          |   // Gyroscope Z-Axis Enabled
                        L3GD20_REG_GYRO_CTRL_REG1_YEN_ENABLE          |   // Gyroscope Y-Axis Enabled
                        L3GD20_REG_GYRO_CTRL_REG1_XEN_ENABLE;             // Gyroscope X-Axis Enabled
    ...
    writeRegister(l3g_i2cAddress, L3GD20_REG_GYRO_CTRL_REG1, config1);
    ...
    */
    ...
    uint8_t config4 =   L3GD20_REG_GYRO_CTRL_REG4_BDU_CONTINUOUS      |   // Continuous Update
                        L3GD20_REG_GYRO_CTRL_REG4_BLE_LSB             |   // Data LSB @ Lower Address
                        L3GD20_REG_GYRO_CTRL_REG4_SIM_4WIRE;              // 4-Wire Interface
    
    config4 |= l3g_gyroscale;      // Full-Scale Selection
    
    // Write the configuration to the Gyroscope Control Register 4
    writeRegister(l3g_i2cAddress, L3GD20_REG_GYRO_CTRL_REG4, config4);
...
*/
/**************************************************************************/
void L3GD20::Measure_Sensor(void)
{
...
void L3GD20::Measure_Gyroscope()
{
    ...
    xGyroLo = readRegister(l3g_i2cAddress, L3GD20_REG_GYRO_OUT_X_L);
    // Reading the High X-Axis Angular Rate Data Register
    xGyroHi = readRegister(l3g_i2cAddress, L3GD20_REG_GYRO_OUT_X_H);
    // Conversion of the result
    // 16-bit signed result for X-Axis Angular Rate Data of L3GD20
    l3g_gyroData.X = (int16_t)((xGyroHi << 8) | xGyroLo);
    
    // Reading the Low Y-Axis Angular Rate Data Register
    yGyroLo = readRegister(l3g_i2cAddress, L3GD20_REG_GYRO_OUT_Y_L);
    // Reading the High Y-Axis Angular Rate Data Register
    yGyroHi = readRegister(l3g_i2cAddress, L3GD20_REG_GYRO_OUT_Y_H);
    // Conversion of the result
    // 16-bit signed result for Y-Axis Angular Rate Data of L3GD20
    l3g_gyroData.Y = (int16_t)((yGyroHi << 8) | yGyroLo);
    
    // Reading the Low Z-Axis Angular Rate Data Register
    zGyroLo = readRegister(l3g_i2cAddress, L3GD20_REG_GYRO_OUT_Z_L);
    // Reading the High Z-Axis Angular Rate Data Register
    zGyroHi = readRegister(l3g_i2cAddress, L3GD20_REG_GYRO_OUT_Z_H);
    // Conversion of the result
    // 16-bit signed result for Z-Axis Angular Rate Data of L3GD20
