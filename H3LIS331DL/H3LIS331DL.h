...
class H3LIS331DL
{
    protected:
        ...
        uint8_t h3lis_conversionDelay;
        h3lisAccelPowerMode_t h3lis_accelpowermode;
        h3lisAccelDataRate_t h3lis_acceldatarate;
        h3lisAccelZen_t h3lis_accelzen;
        h3lisAccelYen_t h3lis_accelyen;
        h3lisAccelXen_t h3lis_accelxen;
        h3lisAccelBlockData_t h3lis_accelblockdata;
        h3lisAccelEndianData_t h3lis_accelendiandata;
        h3lisAccelRange_t h3lis_accelrange;
        h3lisAccelSPIWire_t h3lis_accelspiwire;
    
    public:
        uint8_t h3lis_i2cAddress;
        h3lisAccelData_t h3lis_accelData;
        void getAddr_H3LIS331DL(uint8_t i2cAddress);
        bool begin(void);
        void setUpAccelerometer(void);
        void Measure_Accelerometer(void);
        void setAccelPowerMode(h3lisAccelPowerMode_t accelpowermode);
        h3lisAccelPowerMode_t getAccelPowerMode(void);
        void setAccelDataRate(h3lisAccelDataRate_t acceldatarate);
        h3lisAccelDataRate_t getAccelDataRate(void);
        void setAccelZen(h3lisAccelZen_t accelzen);
        h3lisAccelZen_t getAccelZen(void);
        void setAccelYen(h3lisAccelYen_t accelyen);
        h3lisAccelYen_t getAccelYen(void);
        void setAccelXen(h3lisAccelXen_t accelxen);
        h3lisAccelXen_t getAccelXen(void);
        void setAccelBlockData(h3lisAccelBlockData_t accelblockdata);
        h3lisAccelBlockData_t getAccelBlockData(void);
        void setAccelEndianData(h3lisAccelEndianData_t accelendiandata);
        h3lisAccelEndianData_t getAccelEndianData(void);
        void setAccelRange(h3lisAccelRange_t accelrange);
        h3lisAccelRange_t getAccelRange(void);
        void setAccelSPIWire(h3lisAccelSPIWire_t accelspiwire);
        h3lisAccelSPIWire_t getAccelSPIWire(void);
