...
/**************************************************************************/
/*
        Instantiates a new SI7020_A20 class with appropriate properties
*/
/**************************************************************************/
void SI7020_A20::getAddr_SI7020_A20(uint8_t i2cAddress)
{
    si_i2cAddress = i2cAddress;
    si_conversionDelay = SI7020_A20_CONVERSIONDELAY;
}
...
*/
/**************************************************************************/
void SI7020_A20::Reset(void)
{
    // Resets the SI7020_A20 with the RESET command
    writeRegister8(si_i2cAddress, SI7020_A20_CMD_RESET);
}
 ...
 */
/**************************************************************************/
void SI7020_A20::setTempMode(siTempMode_t tempmode)
{
 ...
 */
/**************************************************************************/
siTempMode_t SI7020_A20::getTempMode()
{
    return si_tempmode;
}
...
*/
/**************************************************************************/
void SI7020_A20::setHumidityMode(siHumidityMode_t humiditymode)
{
...
*/
/**************************************************************************/
siHumidityMode_t SI7020_A20::getHumidityMode()
{
...
*/
/**************************************************************************/
void SI7020_A20::setResolution(siResolution_t resolution)
{
...
*/
/**************************************************************************/
siResolution_t SI7020_A20::getResolution()
{
...
*/
/**************************************************************************/
void SI7020_A20::setVoltage(siVoltage_t voltage)
{
    si_voltage = voltage;
}
...
*/
/**************************************************************************/
siVoltage_t SI7020_A20::getVoltage()
{
    return si_voltage;
}
...
*/
/**************************************************************************/
void SI7020_A20::setHeaterStatus(siHeaterStatus_t heaterstatus)
{
...
*/
/**************************************************************************/
siHeaterStatus_t SI7020_A20::getHeaterStatus()
{
...
*/
/**************************************************************************/
void SI7020_A20::setHeaterCurrent(siHeaterCurrent_t heatercurrent)
{
...
*/
/**************************************************************************/
siHeaterCurrent_t SI7020_A20::getHeaterCurrent()
{
...
*/
/**************************************************************************/
float SI7020_A20::Measure_Temperature()
{
    ...
    // Sending command to the User register 1 for SI7020_A20
    writeRegister(si_i2cAddress, SI7020_A20_CMD_WRITE_USER_1, tempControl);
    ...
    // Sending command to the Heater Control Register 3 for SI7020_A20
    writeRegister(si_i2cAddress, SI7020_A20_CMD_READ_HEATER_CTRL, heaterControl);
    ...
    // 16-bit unsigned results for the SI7020_A20
 ...
 */
/**************************************************************************/
float SI7020_A20::Measure_OldTemperature()
{
    // Set Measurement Resolution
    uint8_t tempControl = si_resolution;
    ...
    uint16_t rawTemperature;
    float temperature;
    writeRegister8(si_i2cAddress, SI7020_A20_CMD_TEMP_PREV_RH);
    delay(si_conversionDelay);
    rawTemperature = readRegister16(si_i2cAddress);
 ...
 */
/**************************************************************************/
float SI7020_A20::Measure_Humidity()
{
    // Set Measurement Resolution
    uint8_t tempControl = si_resolution;
